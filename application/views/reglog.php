				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							...
							<h2>Registrate para dar Clases o tomar Clases y gana dinero Extra!</h2>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-10 col-md text-left">
					<h3 style="font-size:250%; color:#F35F55">Registrate</h3><br><br>
				</div>
				<div class="col-md-1"></div>
			</div>
			...
			<div class="row">
				<div class="col-md-1"></div>
				<div class="col-md-5 col-md">
					<p>Encuentra todo lo que necesitas para dar seguimiento a tu éxito al dar Clases.</p>
				</div>		
				<div class="col-md-5 col-md">
					<p>Administra tus opciones de pago, revisa el historial de tus clases tomadas y más.</p>
				</div>
				<div class="col-md-1"></div>	
			</div>	
			<div class="row">
				<div class="col-md-1"></div>
			<form  action="<?= base_url('registerprof')?>" method="POST">
				<div class="col-md-5 col-md">
					<button class="reg" type="submit">Registro Profesor</button>
				</div>
			</form>		
			<form  action="<?= base_url('registerestu')?>" method="POST">	
				<div class="col-md-5 col-md">
					<button class="reg" type="submit">Registro Usuario</button>
				</div>
			</form>
				<div class="col-md-1"></div>	
			</div>	
