			...
			<div class="about-content">
				<div class="row animate-box">
					...
					<div class="col-md-6 col-md-pull-6">
						<img class="img-responsive" src="<?= base_url('assets/images/img_bg_1.jpg')?>" alt="about">
						<img class="img-responsive" src="<?= base_url('assets/images/img_bg_2.jpg')?>" alt="about">
					</div>
			...
			<div class="row">
				<div class="col-md-4 col-sm-4 animate-box" data-animate-effect="fadeIn">
					<div class="fh5co-staff">
						<img src="<?=base_url('assets/images/person1.jpg')?>" alt="Free HTML5 Templates by gettemplates.co">
						<h3>Jean Smith</h3>
				...
				<div class="col-md-4 col-sm-4 animate-box" data-animate-effect="fadeIn">
					<div class="fh5co-staff">
						<img src="<?= base_url('assets/images/person2.jpg')?>" alt="Free HTML5 Templates by gettemplates.co">
						<h3>Hush Raven</h3>
				...
				<div class="col-md-4 col-sm-4 animate-box" data-animate-effect="fadeIn">
					<div class="fh5co-staff">
						<img src="<?= base_url('assets/images/person3.jpg')?>" alt="Free HTML5 Templates by gettemplates.co">
						<h3>Alex King</h3>
