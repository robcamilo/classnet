				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							...
							<h2>Optimiza tu tiempo y aprende cosas de forma rapida y eficiente</h2>
						</div>
					</div>
				</div>
			</div>
					...
					<h3 style="color:#F35F55">Inicio sesion</h3>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="email" class="form-control" placeholder="Correo electronico" name="email">
							</div>
						</div>
