				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1 style="font-size:35px">Inicia sesion para dar clases</h1>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 col-md text-center animate-box ">
					...
					<h3 style="color:#F35F55">Inicio sesion</h3>

					<!-- <form action="loginprof" method="POST"> -->
						<?= form_open() ?>
						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="subject">Subject</label> -->
								<input type="text" id="" class="form-control" placeholder="Correo electronico" name="email">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="subject">Subject</label> -->
								<input type="password" id="" class="form-control" placeholder="Contraseña" name="password">
							</div>
						</div>
