				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1 style="font-size:35px">Inicia sesion para tomar clases</h1>
							<h2>Gana dinero extra en tu tiempo libre!</h2>
							<h3 style="color:#F35F55">Usted ha iniciado correctamente</h3>

							<form  action="<?= base_url('conexionprof')?>" method="POST">
							<button type="submit" class="btn btn-primary btn-md">Conectate</button>	
							</form>
						</div>
					</div>
				</div>
