				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1 style="font-size:40px">Registrate para tomar clases</h1>
							<h2>Bienvenido a  ClassNet, Comienza una gran experiencia con nosotros con solo presionar un boton.</h2>
						</div>
					</div>
				</div>
			</div>
	...
	<div id="fh5co-contact">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-md text-center animate-box ">
					<h3 style="color:#F35F55; text-align:left">Cuenta</h3><br>
						...
						<h3 style="color:#F35F55; text-align:left">Perfil</h3><br>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="subject">Subject</label> -->
								<input type="number" id="phone" class="form-control" placeholder="Telefono" name="phone">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<!-- <label for="subject">Subject</label> -->
								<input type="text" id="lenguage" class="form-control" placeholder="Direccion" name="adress">
							</div>
						</div><br>
						<h3 style="color:#F35F55; text-align:left">Pago</h3><br>

						<div class="row form-group">
							<div class="col-md-9">
								<!-- <label for="fname">First Name</label> -->
								<input type="number" id="target" class="form-control" placeholder="Número de trajeta crédito o débito" name="card_credit">
							</div>
							<div class="col-md-3">
								<!-- <label for="lname">Last Name</label> -->
								<input type="number" id="ccv" class="form-control" placeholder="CCV" name="ccv">

							</div>
						</div>
							<h5 style="color:#F35F55; text-align:left">Fecha vencimiento</h5>

						<div class="row form-group">
							<div class="col-md-4">
								<!-- <label for="fname">First Name</label> -->
								<input type="text" id="mes" class="form-control" placeholder="Mes" name="month">
							</div>
							<div class="col-md-4">
								<!-- <label for="lname">Last Name</label> -->
								<input type="text" id="año" class="form-control" placeholder="Año" name="year">
							</div>
							<div class="col-md-4">
								<!-- <label for="lname">Last Name</label> -->
								<input type="text" id="cod_postal" class="form-control" placeholder="Codigo postal" name="cod_postal">
							</div>
						</div>	
