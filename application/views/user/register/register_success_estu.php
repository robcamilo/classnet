			...
			<div class="row">
				...
				<div class="col-xs-10 text-right menu-1">
					<ul>
						...
						<li class="btn-cta"><a href="<?= base_url('loginestu')?>"><span>Iniciar Sesión</span></a></li>
					</ul>
				</div>
			</div>
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							...
							<h2>Bienvenido!	</h2>
							<h3 style="color:#F35F55">Gracias por registrar tu nueva cuenta!</h3	>
							<p style="color:#F35F55">Te has registrado correctamente. Ya puede iniciar sesion!</p>
						</div>
					</div>
				</div>
			</div>
