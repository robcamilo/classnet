				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1>Inicia Sesion</h1>
							<h2>Entra a la plataforma y descubre todo lo que puedes encontrar y hacer!</h2>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-10 col-md text-left">
					<h3 style="font-size:250%; color:#F35F55">Iniciar Sesion</h3><br><br>
				</div>
				<div class="col-md-1"></div>
			</div>
			...
			<div class="row">
				<div class="col-md-1"></div>
				<div class="col-md-5 col-md">
					<p>Gana dinero extra utilizando tus habilidades y conocimientos de una forma divertida y rapida</p>
				</div>		
				<div class="col-md-5 col-md">
					<p>Organiza tu clases de forma sencilla y eficaz</p>
				</div>
				<div class="col-md-1"></div>	
			</div>	
			...
			<div class="row">
				<div class="col-md-1"></div>
				<form  action="<?= base_url('loginprof')?>" method="POST">
				<div class="col-md-5 col-md">
					<button class="reg" type="submit">Inicio de sesion de profesor</button>
				</div>
			</form>		
			<form  action="<?= base_url('loginestu')?>" method="POST">	
				<div class="col-md-5 col-md">
					<button class="reg" type="submit">Inicio de sesion de usuario</button>
				</div>
			</form>
				<div class="col-md-1"></div>	
			</div>
