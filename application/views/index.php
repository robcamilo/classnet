...
<html>
				...
				<div class="col-xs-10 text-right menu-1">
					<ul>
						...
						<?php if (isset($_SESSION['email']) && $_SESSION['logged_in'] === true) : ?>
							...
							<li class="btn-cta"><a href="<?= base_url('conexionprof') ?>"><span>Conectate</span></a></li>
						<?php else : ?>
	...
	<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(<?= base_url('assets/images/img_bg_2.jpg')?>);">
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1 style="font-size:45px">Aprende lo que quieras</h1>
							<h2>EL FUTURO ES TUYO</h2>
							<div class="row">
								<form action="reg_log.php" class="form-inline" id="fh5co-header-subscribe">
									<div class="col-md-8 col-md-offset-2">
										<div class="form-group">
											<input type="text" class="form-control" id="email" placeholder="Ingresa tu correo">
											<button type="submit" class="btn btn-default">Unete Ahora</button>
										</div>
									</div>
								</form>
							</div>
			...
			<div class="row">
				<div class="features">
					...
					<div class="col-half-image-holder animate-box" data-animate-effect="fadeInRight">
						<img class="img-responsive" src="<?= base_url('assets/images/samsungs6.png')?>" alt="samsung">
					</div>
				</div>
			</div>
		</div>
	...
	<div id="fh5co-project">
		...
		<div class="project-content">
			<div class="col-half">
				<div class="project animate-box" style="background-image:url(<?= base_url('assets/images/project-3.jpg')?>);">
					<div class="desc">
			...
			<div class="col-half">
				<div class="project-grid animate-box" style="background-image:url(<?= base_url('assets/images/project-5.jpg')?>);">
					<div class="desc">
						<span>Illustration</span>
						<h3>Project Name</h3>
					</div>
				</div>
				<div class="project-grid animate-box" style="background-image:url(<?= base_url('assets/images/project-2.jpg')?>);">
					<div class="desc">
						<span>Branding</span>
						<h3>Project Name</h3>
					</div>
						...
						<div class="col-md-12 animate-box">
							<div class="testimony">
								<div class="inner text-center">
									<img src="<?= base_url('assets/images/person3.jpg')?>" alt="testimony">
								</div>
								<blockquote>
