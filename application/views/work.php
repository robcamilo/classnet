		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 animate-box">
					<div class="project-grid" style="background-image:url(<?= base_url('assets/images/project-2.jpg')?>">
						<div class="desc">
				...
				<div class="col-md-4 animate-box">
					<div class="project-grid" style="background-image:url(<?= base_url('assets/images/project-3.jpg')?>">
						<div class="desc">
							<span>Application</span>
							<h3><a href="#">Project Name</a></h3>
						</div>
				...
				<div class="col-md-4 animate-box">
					<div class="project-grid" style="background-image:url(<?= base_url('assets/images/project-7.jpg')?>">
						<div class="desc">
							<span>Application</span>
							<h3><a href="#">Project Name</a></h3>
						</div>
				...
				<div class="col-md-4 animate-box">
					<div class="project-grid" style="background-image:url(<?= base_url('assets/images/project-5.jpg')?>">
						<div class="desc">
							<span>Application</span>
							<h3><a href="#">Project Name</a></h3>
						</div>
				...
				<div class="col-md-4 animate-box">
					<div class="project-grid" style="background-image:url(<?= base_url('assets/images/project-6.jpg')?>">
						<div class="desc">
							<span>Application</span>
							<h3><a href="#">Project Name</a></h3>
						</div>
